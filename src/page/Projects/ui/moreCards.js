...
export default function MoreCards() {
  ...
  return (
    <div>
      ...
      >
        This are all Seher's other created projects. See, Explore and Share
      </Typography>{' '}
      {matchesXS ? (
        <Grid
          container
        ...
        >
          <Grid item xs={10}>
            <div style={{ display: 'flex', flexWrap: 'wrap' }}>{SeherMore}</div>
          </Grid>
        </Grid>
      ) : (
        <div style={{ display: 'flex', flexWrap: 'wrap' }}>{SeherMore}</div>
      ...
      <Typography
        ...
        variant={matchesSM ? 'h5' : 'h4'}
      >
        This are all Safin's other created projects. See, Explore and Share
      </Typography>{' '}
      {matchesXS ? (
        <Grid
          container
        ...
        >
          <Grid item xs={10}>
            <div style={{ display: 'flex', flexWrap: 'wrap' }}>{SafinMore}</div>
          </Grid>
        </Grid>
      ) : (
        <div style={{ display: 'flex', flexWrap: 'wrap' }}>{SafinMore}</div>
